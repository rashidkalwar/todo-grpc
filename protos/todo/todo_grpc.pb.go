...
type TodoServiceClient interface {
	...
	ReadTodo(ctx context.Context, in *ReadTodoRequest, opts ...grpc.CallOption) (*Todo, error)
	ReadAllTodos(ctx context.Context, in *NullRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Todos], error)
...
func (c *todoServiceClient) ReadTodo(ctx context.Context, in *ReadTodoRequest, opts ...grpc.CallOption) (*Todo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Todo)
...
func (c *todoServiceClient) ReadAllTodos(ctx context.Context, in *NullRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Todos], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TodoService_ServiceDesc.Streams[0], TodoService_ReadAllTodos_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[NullRequest, Todos]{ClientStream: stream}
...
type TodoService_ReadAllTodosClient = grpc.ServerStreamingClient[Todos]
...
type TodoServiceServer interface {
	...
	ReadTodo(context.Context, *ReadTodoRequest) (*Todo, error)
	ReadAllTodos(*NullRequest, grpc.ServerStreamingServer[Todos]) error
...
func (UnimplementedTodoServiceServer) ReadTodo(context.Context, *ReadTodoRequest) (*Todo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReadTodo not implemented")
}
func (UnimplementedTodoServiceServer) ReadAllTodos(*NullRequest, grpc.ServerStreamingServer[Todos]) error {
	return status.Errorf(codes.Unimplemented, "method ReadAllTodos not implemented")
}
...
func _TodoService_ReadAllTodos_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(NullRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(TodoServiceServer).ReadAllTodos(m, &grpc.GenericServerStream[NullRequest, Todos]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TodoService_ReadAllTodosServer = grpc.ServerStreamingServer[Todos]
